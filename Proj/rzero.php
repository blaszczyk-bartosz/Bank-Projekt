...
<div class="container">
    ...
    <div class='row justify-content-center'>
        ...
        <div class='saldo'><span class='biezace'>SALDO: </span><?php echo $_SESSION['saldo1']; ?></div>
        <div class='numer'><span class='biezace'>NUMER RACHUNKU: </span><?php echo $_SESSION['znrkonta']; ?></div>  
        </div>
    </div>
...
{ 
    ...
    if($story = $polaczenie->query("SELECT * FROM historia WHERE NrKonta='$znr' 
    ORDER BY 2 DESC" ))
        {
            $st = $story->num_rows;
